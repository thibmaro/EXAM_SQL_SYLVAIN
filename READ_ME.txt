Exercice 2 : depuis le tableur Excel récupérer les données (copier coller dans l'IDE) une fois "traitée".

Créer la table avec CREATE TABLE [NOM DE LA TABLE]
		    CHARACTER SET utf8
		    COLLATE	  utf8_general_ci;

Puis créer les champs (colonnes) pour pouvoir remplir (exercice3).

Exercice 3 : INSERT INTO `EXAM_SQL_SYLVAIN`.`dataLatrine` 
(`State`,`Rural_Urban`,`pitLatrine`,`WC`,`otherLatrine`,`noLatrine`)
...
Pour insérer les données dans la table et les colonnes.